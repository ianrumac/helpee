 ...
 */
public class EventsHelpeeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EventsHelpeeAdapter(List<Event> eventList, Context context, AdapterClickListener itemClickListener) {
    ...
    void bindDataToEventView(EventHolder holder, final Event event, final int position) {
        ...
        holder.cancelHelpBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemClickListener.onClick(R.id.btn_cancel_help, position);
            }
        });
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        ...
        @InjectView(R.id.btn_cancel_help)
